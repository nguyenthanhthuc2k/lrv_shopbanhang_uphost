                    ...
                    <div class="col-sm-4">
                        <form method="POST" action="{{URL::to('/tim-kiem')}}">
                            ...
                            <div class="search_box pull-right">
                                <input type="text" name="keysword_submit" placeholder="Tìm kiếm.."/>  
                                <input type="submit" style="margin-top: 0; color: #fff;width: 40px;"name="submit_keysword" class="btn btn-primary" value="Tìm"> 
                             </div>
                        </form>
                    </div>
                </div>
        ...
        $(document).ready(function(){
             $('.calculator_delivery').click(function(){
                ...
                if(city =='' && province =='' && wards ==''){
                    alert('Chon địa chỉ đi thằng lol');
                }else{
                    $.ajax({
    ...
    <script type="text/javascript">
         ...
         $('.send-order').click(function(){
            if($('.shipping_email').val() == '' || $('.shipping_name').val() == ''|| $('.shipping_phone').val() == ''|| $('.shipping_address').val() == ''|| $('.shipping_notes').val() == ''|| $('.payment').val() == ''){
                swal("Thanks!", "Vui lòng nhập thông tin nhận hàng", "error");
            }
            else if($('.shipping_fee').val() == ''){
                 swal("Thanks!", "Vui lòng tính phí vận chuyển", "error");
             }
            else{
                swal({
                  title: "Xác nhận đơn hàng ?",
                  text: "Bạn có  chắn chắn muốn đặt hàng!",
                  type: "success",
                  showCancelButton: true,
                  confirmButtonClass: "btn-danger",
                  confirmButtonText: "Ok, Chốt đơn",
                ...
                function(isConfirm){
                    if (isConfirm) {
                        ...
                        $.ajax({
                            ...
                            success:function(data){
                                 swal("Thanks!", "Đơn hàng của bạn đã được tiếp nhận chờ xữ lí", "success");
                                //  $('form :input').val('');
                                // $('form :select').val('');
                            }
                        })
                        ...
                        swal("Thanks!", "Đơn hàng  đã hủy :<", "error");
                      }
                });
            }
